...
def gen(request):
    ...
    if fixture is None or not fixture.is_valid():
        fixture = General(browser=browser, base_url=web_config["baseUrl"])
...
def db(request):
    ...
    dbfixtue = DbFixture(host=db_config["host"], name=db_config["name"], user=db_config["user"], password=db_config["password"])
    def fin():
        dbfixtue.destroy()
